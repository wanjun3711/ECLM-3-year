...
# 创建并训练XGBoost模型
xgb_params = {
    'alpha': 0.08162711457216032,
    'eta': 0.7341621020363812,
    'gamma': 1.3111723586688129,
    'max_delta_step': 7,
    'max_depth': 7,
    'min_child_weight': 1,
    'n_estimators': 56,
    'subsample': 0.4871453627808089,
}
...
# 创建Web应用程序
st.title("3-year survival of ECLM patients based on XGBoost")
